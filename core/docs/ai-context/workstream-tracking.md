...
CI is green, the reviewer's pass has returned for the head commit, and every
thread is resolved — see CLAUDE.md's close-out contract), and the **scope-of-work gate** was added
